...
<html>
<head>
	<link href="${pageContext.request.contextPath }/css/nsfw/css.css" rel="stylesheet" type="text/css" />
	<link href="${pageContext.request.contextPath }/css/nsfw/style.css" rel="stylesheet" type="text/css" />
...
<body>
	<!-- 头部{ -->
	<table width="1222" border="0" align="center" cellpadding="0" cellspacing="0" background="${pageContext.request.contextPath }/images/nsfw/xingzheng.png" class="top">
		<tr>
			...
			<td width="300" align="right" valign="top">
				<table width="350" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
					    <td align="center"></td>
                        <td align="left"></td>
                        <td align="left"><a><b></b><font color="red">欢迎您,${loginUser.name}</font></a></td>
                        <td align="center"><img src="${pageContext.request.contextPath }/images/nsfw/help.png" width="12"height="17" /></td>
						<td align="left"><a href="javascript:void(0)">帮助</a></td>
						<td width="17" align="center"><img src="${pageContext.request.contextPath }/images/nsfw/exit.png"width="14" height="14"/></td>
						<td align="left" valign="middle"><a href="${pageContext.request.contextPath }/demo/exit" target="_top">退出</a></td>
					</tr>
				</table>
			</td>
		</tr>
	...
	<div class="banner">
		<div class="menu">
			<ul class="clearfix">
				<li><a href="${pageContext.request.contextPath}/home/home.jsp" target="_top">工作主页</a></li>
